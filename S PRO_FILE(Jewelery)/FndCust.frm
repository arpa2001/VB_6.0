...
Begin VB.Form FndCust 
   Caption         =   "Search"
   ClientHeight    =   11010
   ClientLeft      =   -135
   ClientTop       =   255
   ClientWidth     =   20370
   Icon            =   "FndCust.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   11010
   ScaleWidth      =   20370
   WindowState     =   2  'Maximized
   Begin MSDataListLib.DataCombo CustNm 
      Bindings        =   "FndCust.frx":57E2
      DataSource      =   "CustAdo"
      Height          =   315
      Left            =   2280
      TabIndex        =   1
   ...
   Begin MSAdodcLib.Adodc CustAdo 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "Select * from Customers order by CustmNm"
      Caption         =   "CustAdo"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
   ...
   End
End
Attribute VB_Name = "FndCust"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub CustNm_Change()
CustAdo.Refresh
CustAdo.Recordset.Filter = "[CustmNm]='" & CustNm.Text & "'"
